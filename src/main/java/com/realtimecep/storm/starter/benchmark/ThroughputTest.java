package com.realtimecep.storm.starter.benchmark;
...
/**
 * storm jar rt-statss-pilot-0.1.0-SNAPSHOT-jar-with-dependencies.jar com.realtimecep.storm.starter.benchmark.ThroughputTest demo 100 8 8 8 10000
 */
